...
popGen, population = geneticAlgorythm(population, elitePercentage, mutationPercentage, crossoverPoint1, crossoverPoint2, values, weights, maxCapacity)
printPopulation(population)
println("Ukupan broj kamenja je $numberOfRocks")
println("Tezine kamenja su $weights")
println("Vrednost kamenja su $values")
...
if sumWeights > maxCapacity
        ...
        println("Idealna jedinka je $(population[1])")
        println("Izabrana su kamenja pod rednim brojevima: ")
