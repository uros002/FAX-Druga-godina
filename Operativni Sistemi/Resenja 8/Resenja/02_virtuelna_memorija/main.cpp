...
// Program je predstavljen klasom Program. Konstruktoru klase prosleđuje se ukupni kapacitet RAM-a. Nit predstavljena datom funkcijom "izvrsavanje" izvršava listu naredbi programa pozivom metode izvrsi_naredbu() klase Program. Metoda izvrsi_naredbu() izvršava prosleđenu naredbu. Moguće naredbe su:
// - malloc(X) - zauzima se X količina memorije i
// - repeat[N]malloc(X) - N puta se zauzima količina memorije X
//
// Pri zauzimanju memorije, pokušava se zauzeti RAM. Ukoliko nema dovoljno RAM-a, vrši se zauzimanje virtuelne memorije. U ovoj simulaciji kapacitet virtuelne memorije je neograničen.
//
