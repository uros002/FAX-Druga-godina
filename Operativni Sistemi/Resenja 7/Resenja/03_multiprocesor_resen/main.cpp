...
//
// Deljena memorija je predstavljena klasom Memorija. Prilikom instanciranja se zadaje veličina memorije (ukupan broj lokacija koje postoje u memoriji). Upis vrednosti u memoriju se obavlja pozivom operacije Memorija.pisi, a čitanje pozivom operacije Memorija.citaj. I čitanje i upis svake vrednosti traje po 1 sekundu. Ove dve metode kao parametar prihvataju memorijsku lokaciju (ona je izražena u bajtima/karakterima). Interno, sve lokacije kojе čine memoriju mogu se predstaviti karakterima (tip char).
//
